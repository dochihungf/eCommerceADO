...
namespace eCommerce.Model.Validators.Promotions;

public class EditPromotionModelValidator : AbstractValidator<EditPromotionModel>
{
    public EditPromotionModelValidator()
    {
        RuleFor(x => x.Code)
            .NotEmpty()
